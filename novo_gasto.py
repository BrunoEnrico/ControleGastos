...
def inserir_gasto():
    ...
    # título
    l = Label(root, text = "NOVO GASTO", font = ("Arial", "12", "bold"))
    ...
    l = Label(frame1, text = "Descrição: ", font = font)
    ...
    l = Label(frame2, text = "Valor: ", font = font)
    ...
    l = Label(frame3, text = "Data: ", font = font)
    l.pack(side = LEFT, pady = 10, padx = 10)
